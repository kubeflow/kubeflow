...
INPUT=()
FORMAT=()
export KUBEFLOW_COMPONENTS=${DEFAULT_KUBEFLOW_COMPONENTS:-'"ambassador","jupyter","notebook-controller","centraldashboard","tf-job-operator","pytorch-operator","spartakus","argo","pipeline"'}
