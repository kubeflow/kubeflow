...
INPUT=()
FORMAT=()
export KUBEFLOW_COMPONENTS=${DEFAULT_KUBEFLOW_COMPONENTS:-'"ambassador","jupyter","notebooks","profiles","centraldashboard","tf-job-operator","pytorch-operator","spartakus","argo","pipeline"'}
