...
install_istio() {
  ...
  curl -o ${KUBEFLOW_K8S_MANIFESTS_DIR}/istio-crds.yaml \
    https://raw.githubusercontent.com/kubeflow/kubeflow/${KUBEFLOW_VERSION}/dependencies/istio/install/crds.yaml

  # istio-ingressgateway is of type NodePort instead of LoadBalancer
  curl -o ${KUBEFLOW_K8S_MANIFESTS_DIR}/istio-noauth.yaml \
    https://raw.githubusercontent.com/kubeflow/kubeflow/${KUBEFLOW_VERSION}/dependencies/istio/install/istio-noauth.yaml
