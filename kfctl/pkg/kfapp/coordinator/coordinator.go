...
import (
	...
	"github.com/kubeflow/kubeflow/kfctl/v2/config"
	kfapis "github.com/kubeflow/kubeflow/kfctl/v2/pkg/apis"
	...
	"github.com/kubeflow/kubeflow/kfctl/v2/pkg/kfapp/kustomize"
	"github.com/kubeflow/kubeflow/kfctl/v2/pkg/kfapp/minikube"
...
func GetKfApp(kfdef *kfdefsv2.KfDef, platformArgs []byte) kftypesv2.KfApp {
...
func getPlatform(kfdef *kfdefsv2.KfDef, platformArgs []byte) (kftypesv2.Platform, error) {
...
func getPackageManager(packagemanager string, kfdef *kfdefsv2.KfDef, platform kftypesv2.Platform) (kftypesv2.KfApp, error) {
	packagemanager = strings.Split(packagemanager, "@")[0]
	switch packagemanager {
	case kftypesv2.KUSTOMIZE:
		return kustomize.GetKfApp(kfdef, platform), nil
	default:
		log.Infof("** loading %v.so for package manager %v **", packagemanager, packagemanager)
		return kftypesv2.LoadKfApp(packagemanager, kfdef, platform)
	}
}
...
func LoadKfApp(options map[string]interface{}) (kftypesv2.KfApp, error) {
	...
	} else if kfdef.Spec.Platform == kftypesv2.GCP && kfdef.Spec.Zone == "" {
...
// eg Platforms[kftypesv2.GCP], Platforms[kftypesv2.MINIKUBE], PackageManagers["kustomize"]
