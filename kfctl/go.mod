module github.com/kubeflow/kubeflow/kfctl/v2
...
require (
	...
	github.com/kubernetes-sigs/application v0.0.0-20190404151855-67ae7f915d4e // indirect
	...
	sigs.k8s.io/kustomize v0.0.0-20190618214009-af67c893d87c
...
replace (
	...
	sigs.k8s.io/kustomize => sigs.k8s.io/kustomize v0.0.0-20190618214009-af67c893d87c
)
