          ...
          templates: [
            {
              ...
              dag: {
                tasks: std.prune([
                  ...
                  if platform == "gke" then {
                    name: "setup-gke" + v1alpha1Suffix,
                    template: "setup-gke" + v1alpha1Suffix,
                    dependencies: ["bootstrap-kf-gcp" + v1alpha1Suffix],
                  },
                  {
                  ...
                  if platform == "gke" then {
                    name: "bootstrap-kf-gcp" + v1alpha1Suffix,
                    template: "bootstrap-kf-gcp" + v1alpha1Suffix,
                    dependencies: ["bootstrap-image-create"],
                  },
                  {
                  ...
                  if platform == "gke" then {
                    name: "wait-for-kubeflow" + v1alpha1Suffix,
                    template: "wait-for-kubeflow" + v1alpha1Suffix,
                    dependencies: [
                      "setup-gke" + v1alpha1Suffix,
                    ],
                  } else {},
                  {
                    name: "jsonnet-test",
            ...
            },  // e2e template
            {
              ...
              dag: {
                tasks: [
                  ...
                  if platform == "gke" then
                    {
                      name: "teardown-kubeflow-gcp" + v1alpha1Suffix,
                      template: "teardown-kubeflow-gcp" + v1alpha1Suffix,
                    },
                  if platform == "gke" then
                    {
            ...
            buildTemplate("wait-for-kubeflow" + v1alpha1Suffix, [
              "python",
              "-m",
              "testing.wait_for_deployment",
              "--cluster=" + cluster,
              ...
              "--zone=" + zone,
              "--timeout=5",
            ], kubeConfig="v1alpha1"),  // wait-for-kubeflow
            ...
            buildTemplate("setup-gke" + v1alpha1Suffix, [
              "python",
              "-m",
              "testing.get_gke_credentials",
              "--test_dir=" + testDir,
              "--project=" + project,
              "--cluster=" + cluster + v1alpha1Suffix,
              "--zone=" + zone,
            ], kubeConfig="v1alpha1"),  // setup-gke
            ...
            buildTemplate("tfjob-test" + v1alpha1Suffix, [
              "python",
              "-m",
              "py.test_runner",
              "test",
              ...
              "--junit_path=" + artifactsDir + "/junit_e2e-" + platform + v1alpha1Suffix + ".xml",
            ], kubeConfig="v1alpha1"),  // run tests
            ...
            buildTemplate("bootstrap-kf-gcp" + v1alpha1Suffix, [
              "python",
              "-m",
              "testing.deploy_kubeflow_gcp",
              "--project=" + project,
              "--name=" + deploymentName + v1alpha1Suffix,
              "--config=" + srcDir + "/testing/dm_configs/cluster-kubeflow.yaml",
              "--imports=" + srcDir + "/testing/dm_configs/cluster.jinja",
              "--bootstrapper_image=" + bootstrapperImage,
              "--tfjob_version=v1alpha1",
            ]),  // bootstrap-kf-gcp-v1alpha1
            ...
            buildTemplate("teardown-kubeflow-gcp" + v1alpha1Suffix, [
              "python",
              "-m",
              "testing.teardown_kubeflow_gcp",
              "--project=" + project,
