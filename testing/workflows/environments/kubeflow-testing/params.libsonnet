...
params {
  components+: {
    ...
    kfctl_go_test+: {
      namespace: 'kubeflow-test-infra',
      name: 'jlewi-kfctl-test-2672-0309-163132',
      prow_env: 'JOB_NAME=kfctl-test,JOB_TYPE=presubmit,REPO_NAME=kubeflow,REPO_OWNER=kubeflow,BUILD_NUMBER=0309-163132,PULL_NUMBER=2672',
      deleteKubeflow: true,
    },
  },
}