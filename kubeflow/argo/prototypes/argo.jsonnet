...
// @optionalParam workflowControllerImage string gcr.io/ml-pipeline/workflow-controller:v2.3.0 workflowControllerImage
// @optionalParam uiImage string gcr.io/ml-pipeline/argoui:v2.3.0 uiImage
// @optionalParam executorImage string gcr.io/ml-pipeline/argoexec:v2.3.0 executorImage
