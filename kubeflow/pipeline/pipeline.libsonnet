{
  ...
  params:: {
    apiImage: "gcr.io/ml-pipeline/api-server:0.1.14",
    scheduledWorkflowImage: "gcr.io/ml-pipeline/scheduledworkflow:0.1.14",
    persistenceAgentImage: "gcr.io/ml-pipeline/persistenceagent:0.1.14",
    viewerCrdControllerImage: "gcr.io/ml-pipeline/viewer-crd-controller:0.1.14",
    uiImage: "gcr.io/ml-pipeline/frontend:0.1.14",
