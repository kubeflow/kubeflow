{
  ...
  params:: {
    apiImage: "gcr.io/ml-pipeline/api-server:0.1.9",
    scheduledWorkflowImage: "gcr.io/ml-pipeline/scheduledworkflow:0.1.9",
    persistenceAgentImage: "gcr.io/ml-pipeline/persistenceagent:0.1.9",
    uiImage: "gcr.io/ml-pipeline/frontend:0.1.9",
    mysqlImage: "mysql:5.6",
    minioImage: "minio/minio:RELEASE.2018-02-09T22-40-05Z",
    nfsImage: "k8s.gcr.io/volume-nfs:0.8",
    viewerCrdControllerImage: "gcr.io/ml-pipeline/viewer-crd-controller:0.1.9",
    mysqlPvName: null,
    minioPvName: null,
    nfsPvName: null,
    mysqlPd: null,
