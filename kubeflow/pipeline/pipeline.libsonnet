{
  ...
  params:: {
    apiImage: "gcr.io/ml-pipeline/api-server:0.1.15",
    scheduledWorkflowImage: "gcr.io/ml-pipeline/scheduledworkflow:0.1.15",
    persistenceAgentImage: "gcr.io/ml-pipeline/persistenceagent:0.1.15",
    viewerCrdControllerImage: "gcr.io/ml-pipeline/viewer-crd-controller:0.1.15",
    uiImage: "gcr.io/ml-pipeline/frontend:0.1.15",
