{
  all(params):: [
    ...
    $.parts(params.namespace).jupyterHub(params.jupyterHubImage, params.jupyterNotebookPVCMount, params.cloud, params.jupyterNotebookRegistry, params.jupyterNotebookRepoName, params.jupyterHubAuthenticator, params.disks),
  ...
  parts(namespace):: {
    ...
    jupyterHub(image, notebookPVCMount, cloud, registry, repoName, jupyterHubAuthenticator, disks): {
