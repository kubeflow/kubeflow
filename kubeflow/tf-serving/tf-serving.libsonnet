{
  ...
  params:: {
    ...
    defaultCpuImage: "gcr.io/kubeflow-images-staging/tf-model-server-cpu:v20180326-b0c432b9",
    defaultGpuImage: "gcr.io/kubeflow-images-staging/tf-model-server-gpu:v20180326-b0c432b9",
