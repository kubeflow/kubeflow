...
This config file app.yaml is generated by the init subcommand and used by generate and apply 
subcommands. The `app.yaml` will be generated in the current directory if <name> is 
...
different platforms. See Typical use-case above.
