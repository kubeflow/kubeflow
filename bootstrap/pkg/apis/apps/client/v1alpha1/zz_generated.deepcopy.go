...
import (
	apps "github.com/kubeflow/kubeflow/bootstrap/pkg/apis/apps"
...
func (in *ClientSpec) DeepCopyInto(out *ClientSpec) {
	*out = *in
	...
	if in.Parameters != nil {
		...
		*out = make(map[string][]apps.NameValue, len(*in))
		for key, val := range *in {
			var outVal []apps.NameValue
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make([]apps.NameValue, len(*in))
				copy(*out, *in)
			}
			(*out)[key] = outVal
		}
