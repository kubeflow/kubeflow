...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KsApp) DeepCopyInto(out *KsApp) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KsApp.
func (in *KsApp) DeepCopy() *KsApp {
	if in == nil {
		return nil
	}
	out := new(KsApp)
...
func (in *KsApp) DeepCopyObject() runtime.Object {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KsAppCondition) DeepCopyInto(out *KsAppCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KsAppCondition.
func (in *KsAppCondition) DeepCopy() *KsAppCondition {
	if in == nil {
		return nil
	}
	out := new(KsAppCondition)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KsAppList) DeepCopyInto(out *KsAppList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]KsApp, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KsAppList.
func (in *KsAppList) DeepCopy() *KsAppList {
	if in == nil {
		return nil
	}
	out := new(KsAppList)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *KsAppList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KsAppSpec) DeepCopyInto(out *KsAppSpec) {
	*out = *in
	if in.Components != nil {
		in, out := &in.Components, &out.Components
	...
	if in.Parameters != nil {
		in, out := &in.Parameters, &out.Parameters
		*out = make(map[string][]NameValue, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KsAppSpec.
func (in *KsAppSpec) DeepCopy() *KsAppSpec {
	if in == nil {
		return nil
	}
	out := new(KsAppSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KsAppStatus) DeepCopyInto(out *KsAppStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]KsAppCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KsAppStatus.
func (in *KsAppStatus) DeepCopy() *KsAppStatus {
	if in == nil {
		return nil
	}
	out := new(KsAppStatus)
