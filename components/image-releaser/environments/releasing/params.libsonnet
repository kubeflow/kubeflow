...
local envParams = params {
  components+: {
    ...
    "tf-notebook-workflow"+: {
      name: 'tensorflow-notebook-image-release-v20180602-336fa336',
      namespace: 'kubeflow-releasing',
      versionTag: 'v20180602-336fa336',
      ...
      prowEnv: 'BUILD_ID=9154,BUILD_NUMBER=9154,JOB_NAME=tensorflow-notebook-image-release,JOB_TYPE=presubmit,PULL_BASE_SHA=b373383560ae844b9e677ac67e0290e6e980b7ee,PULL_NUMBER=916,PULL_PULL_SHA=336fa33689d0c6241c523bd972d1c980037151dc,REPO_NAME=kubeflow,REPO_OWNER=kubeflow',
    },
    workflows+: {
