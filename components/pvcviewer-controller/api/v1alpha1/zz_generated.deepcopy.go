...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PVCViewerCondition) DeepCopyInto(out *PVCViewerCondition) {
	*out = *in
	in.LastProbeTime.DeepCopyInto(&out.LastProbeTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PVCViewerCondition.
func (in *PVCViewerCondition) DeepCopy() *PVCViewerCondition {
	if in == nil {
		return nil
	}
	out := new(PVCViewerCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PVCViewerStatus) DeepCopyInto(out *PVCViewerStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]PVCViewerCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
