...
class MetaHandler(tornado.web.RequestHandler):
  """
  Meta Handler proxy return Model metadata. Defined here https://github.com/tensorflow/serving/blob/master/tensorflow_serving/apis/prediction_service.proto#L29
  """
  @gen.coroutine
