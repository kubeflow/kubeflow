...
class V1SubjectAccessReviewSpec(object):
    ...
    def __init__(self, extra=None, groups=None, non_resource_attributes=None, resource_attributes=None, uid=None, user=None):
        """
    ...
    def uid(self):
        """
        Gets the uid of this V1SubjectAccessReviewSpec.
        UID information about the requesting user.

        :return: The uid of this V1SubjectAccessReviewSpec.
        :rtype: str
        """
        return self._uid
