...
class V2beta2HorizontalPodAutoscalerSpec(object):
    """
    ...
    def __init__(self, max_replicas=None, metrics=None, min_replicas=None, scale_target_ref=None):
        """
        V2beta2HorizontalPodAutoscalerSpec - a model defined in Swagger
        """
    ...
    def max_replicas(self):
        """
        Gets the max_replicas of this V2beta2HorizontalPodAutoscalerSpec.
    ...
    def metrics(self, metrics):
        ...
        :param metrics: The metrics of this V2beta2HorizontalPodAutoscalerSpec.
    ...
    def min_replicas(self):
        """
        Gets the min_replicas of this V2beta2HorizontalPodAutoscalerSpec.
        minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down. It defaults to 1 pod.

        :return: The min_replicas of this V2beta2HorizontalPodAutoscalerSpec.
        :rtype: int
        """
    ...
    def min_replicas(self, min_replicas):
        ...
        :param min_replicas: The min_replicas of this V2beta2HorizontalPodAutoscalerSpec.
        :type: int
        """
    ...
    def scale_target_ref(self):
        """
        Gets the scale_target_ref of this V2beta2HorizontalPodAutoscalerSpec.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2beta2HorizontalPodAutoscalerSpec):
            return False
