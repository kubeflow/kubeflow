...
class V1beta1NonResourceRule(object):
    """
    ...
    def __init__(self, non_resource_ur_ls=None, verbs=None):
        """
        V1beta1NonResourceRule - a model defined in Swagger
        """
    ...
    def non_resource_ur_ls(self):
        """
        Gets the non_resource_ur_ls of this V1beta1NonResourceRule.
        NonResourceURLs is a set of partial urls that a user should have access to.  *s are allowed, but only as the full, final step in the path.  \"*\" means all.

        :return: The non_resource_ur_ls of this V1beta1NonResourceRule.
        :rtype: list[str]
        """
    ...
    def non_resource_ur_ls(self, non_resource_ur_ls):
        ...
        :param non_resource_ur_ls: The non_resource_ur_ls of this V1beta1NonResourceRule.
        :type: list[str]
        """
    ...
    def verbs(self):
        """
        Gets the verbs of this V1beta1NonResourceRule.
        Verb is a list of kubernetes non-resource API verbs, like: get, post, put, delete, patch, head, options.  \"*\" means all.

        :return: The verbs of this V1beta1NonResourceRule.
        :rtype: list[str]
        """
        return self._verbs
    ...
    def verbs(self, verbs):
        """
        Sets the verbs of this V1beta1NonResourceRule.
        Verb is a list of kubernetes non-resource API verbs, like: get, post, put, delete, patch, head, options.  \"*\" means all.

        :param verbs: The verbs of this V1beta1NonResourceRule.
        :type: list[str]
        """
        if verbs is None:
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V1beta1NonResourceRule):
            return False
