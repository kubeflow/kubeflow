...
class V1alpha1PriorityClass(object):
    ...
    def __init__(self, api_version=None, description=None, global_default=None, kind=None, metadata=None, value=None):
        """
        V1alpha1PriorityClass - a model defined in Swagger
        """
    ...
    def api_version(self):
        """
        Gets the api_version of this V1alpha1PriorityClass.
        APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources

        :return: The api_version of this V1alpha1PriorityClass.
        :rtype: str
        """
    ...
    def api_version(self, api_version):
        ...
        :param api_version: The api_version of this V1alpha1PriorityClass.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this V1alpha1PriorityClass.
    ...
    def global_default(self):
        """
        Gets the global_default of this V1alpha1PriorityClass.
        globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class. Only one PriorityClass can be marked as `globalDefault`. However, if more than one PriorityClasses exists with their `globalDefault` field set to true, the smallest value of such global default PriorityClasses will be used as the default priority.

        :return: The global_default of this V1alpha1PriorityClass.
        :rtype: bool
        """
    ...
    def kind(self):
        """
        Gets the kind of this V1alpha1PriorityClass.
    ...
    def metadata(self):
        """
        Gets the metadata of this V1alpha1PriorityClass.
    ...
    def metadata(self, metadata):
        ...
        :param metadata: The metadata of this V1alpha1PriorityClass.
        :type: V1ObjectMeta
        """
    ...
    def value(self):
        """
        Gets the value of this V1alpha1PriorityClass.
        The value of this priority class. This is the actual priority that pods receive when they have the name of this class in their pod spec.

        :return: The value of this V1alpha1PriorityClass.
        :rtype: int
        """
        return self._value
