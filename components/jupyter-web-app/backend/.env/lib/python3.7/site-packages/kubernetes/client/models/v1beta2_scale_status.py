...
class V1beta2ScaleStatus(object):
    ...
    def __init__(self, replicas=None, selector=None, target_selector=None):
        """
        V1beta2ScaleStatus - a model defined in Swagger
        """
    ...
    def replicas(self):
        """
        Gets the replicas of this V1beta2ScaleStatus.
        actual number of observed instances of the scaled object.

        :return: The replicas of this V1beta2ScaleStatus.
        :rtype: int
        """
    ...
    def replicas(self, replicas):
        ...
        :param replicas: The replicas of this V1beta2ScaleStatus.
        :type: int
        """
        if replicas is None:
    ...
    def selector(self):
        """
        Gets the selector of this V1beta2ScaleStatus.
        label query over pods that should match the replicas count. More info: http://kubernetes.io/docs/user-guide/labels#label-selectors

        :return: The selector of this V1beta2ScaleStatus.
        :rtype: dict(str, str)
        """
    ...
    def selector(self, selector):
        ...
        :param selector: The selector of this V1beta2ScaleStatus.
        :type: dict(str, str)
        """
    ...
    def target_selector(self):
        """
        Gets the target_selector of this V1beta2ScaleStatus.
        label selector for pods that should match the replicas count. This is a serializated version of both map-based and more expressive set-based selectors. This is done to avoid introspection in the clients. The string will be in the same format as the query-param syntax. If the target type only supports map-based selectors, both this field and map-based selector field are populated. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors

        :return: The target_selector of this V1beta2ScaleStatus.
        :rtype: str
        """
