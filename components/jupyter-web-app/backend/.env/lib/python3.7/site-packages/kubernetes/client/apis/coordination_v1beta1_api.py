...
class CoordinationV1beta1Api(object):
    ...
    def delete_namespaced_lease(self, name, namespace, body, **kwargs):
        """
        delete a Lease
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_namespaced_lease(name, namespace, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_namespaced_lease_with_http_info(name, namespace, body, **kwargs)
        else:
            (data) = self.delete_namespaced_lease_with_http_info(name, namespace, body, **kwargs)
            return data

    def delete_namespaced_lease_with_http_info(self, name, namespace, body, **kwargs):
        """
        delete a Lease
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_namespaced_lease_with_http_info(name, namespace, body, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `delete_namespaced_lease`")
