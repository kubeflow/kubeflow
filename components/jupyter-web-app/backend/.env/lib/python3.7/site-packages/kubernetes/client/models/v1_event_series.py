...
class V1EventSeries(object):
    ...
    def __init__(self, count=None, last_observed_time=None, state=None):
        """
        V1EventSeries - a model defined in Swagger
        """
    ...
    def count(self):
        """
        Gets the count of this V1EventSeries.
        Number of occurrences in this series up to the last heartbeat time

        :return: The count of this V1EventSeries.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        ...
        :param count: The count of this V1EventSeries.
        :type: int
        """
    ...
    def state(self):
        """
        Gets the state of this V1EventSeries.
        State of this Series: Ongoing or Finished

        :return: The state of this V1EventSeries.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        ...
        :param state: The state of this V1EventSeries.
        :type: str
        """
