...
class V1DaemonSetUpdateStrategy(object):
    ...
    def __init__(self, rolling_update=None, type=None):
        """
        V1DaemonSetUpdateStrategy - a model defined in Swagger
        """
    ...
    def rolling_update(self):
        """
        Gets the rolling_update of this V1DaemonSetUpdateStrategy.
        Rolling update config params. Present only if type = \"RollingUpdate\".

        :return: The rolling_update of this V1DaemonSetUpdateStrategy.
    ...
    def rolling_update(self, rolling_update):
        ...
        :param rolling_update: The rolling_update of this V1DaemonSetUpdateStrategy.
    ...
    def type(self):
        """
        Gets the type of this V1DaemonSetUpdateStrategy.
