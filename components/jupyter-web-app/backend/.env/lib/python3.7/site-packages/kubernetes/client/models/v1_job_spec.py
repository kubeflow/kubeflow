...
class V1JobSpec(object):
    ...
    def __init__(self, active_deadline_seconds=None, backoff_limit=None, completions=None, manual_selector=None, parallelism=None, selector=None, template=None, ttl_seconds_after_finished=None):
        """
    ...
    def ttl_seconds_after_finished(self, ttl_seconds_after_finished):
        ...
        :param ttl_seconds_after_finished: The ttl_seconds_after_finished of this V1JobSpec.
        :type: int
        """
