...
class ExtensionsV1beta1RollingUpdateDeployment(object):
    ...
    def __init__(self, max_surge=None, max_unavailable=None):
        """
        ExtensionsV1beta1RollingUpdateDeployment - a model defined in Swagger
        """
    ...
    def max_surge(self):
        """
        Gets the max_surge of this ExtensionsV1beta1RollingUpdateDeployment.
        ...
        :return: The max_surge of this ExtensionsV1beta1RollingUpdateDeployment.
        :rtype: object
        """
    ...
    def max_surge(self, max_surge):
        ...
        :param max_surge: The max_surge of this ExtensionsV1beta1RollingUpdateDeployment.
        :type: object
        """
    ...
    def max_unavailable(self):
        """
        Gets the max_unavailable of this ExtensionsV1beta1RollingUpdateDeployment.
        The maximum number of pods that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). Absolute number is calculated from percentage by rounding down. This can not be 0 if MaxSurge is 0. By default, a fixed value of 1 is used. Example: when this is set to 30%, the old RC can be scaled down to 70% of desired pods immediately when the rolling update starts. Once new pods are ready, old RC can be scaled down further, followed by scaling up the new RC, ensuring that the total number of pods available at all times during the update is at least 70% of desired pods.

        :return: The max_unavailable of this ExtensionsV1beta1RollingUpdateDeployment.
        :rtype: object
        """
    ...
    def max_unavailable(self, max_unavailable):
        ...
        :param max_unavailable: The max_unavailable of this ExtensionsV1beta1RollingUpdateDeployment.
        :type: object
        """
