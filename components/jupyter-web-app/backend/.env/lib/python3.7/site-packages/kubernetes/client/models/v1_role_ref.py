...
class V1RoleRef(object):
    ...
    def __init__(self, api_group=None, kind=None, name=None):
        """
        V1RoleRef - a model defined in Swagger
        """
    ...
    def api_group(self):
        """
        Gets the api_group of this V1RoleRef.
        APIGroup is the group for the resource being referenced

        :return: The api_group of this V1RoleRef.
        :rtype: str
        """
    ...
    def api_group(self, api_group):
        ...
        :param api_group: The api_group of this V1RoleRef.
        :type: str
        """
    ...
    def kind(self):
        """
        Gets the kind of this V1RoleRef.
        Kind is the type of resource being referenced

        :return: The kind of this V1RoleRef.
        :rtype: str
        """
        return self._kind
    ...
    def kind(self, kind):
        ...
        :param kind: The kind of this V1RoleRef.
        :type: str
        """
        if kind is None:
    ...
    def name(self):
        """
        Gets the name of this V1RoleRef.
        Name is the name of resource being referenced

        :return: The name of this V1RoleRef.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        ...
        :param name: The name of this V1RoleRef.
        :type: str
        """
        if name is None:
