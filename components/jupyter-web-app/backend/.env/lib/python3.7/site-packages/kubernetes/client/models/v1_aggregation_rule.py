...
class V1AggregationRule(object):
    ...
    def __init__(self, cluster_role_selectors=None):
        """
        V1AggregationRule - a model defined in Swagger
        """
    ...
    def cluster_role_selectors(self):
        """
        Gets the cluster_role_selectors of this V1AggregationRule.
        ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added

        :return: The cluster_role_selectors of this V1AggregationRule.
    ...
    def cluster_role_selectors(self, cluster_role_selectors):
        ...
        :param cluster_role_selectors: The cluster_role_selectors of this V1AggregationRule.
