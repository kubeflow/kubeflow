...
class ExtensionsV1beta1DeploymentStatus(object):
    ...
    def collision_count(self):
        """
        Gets the collision_count of this ExtensionsV1beta1DeploymentStatus.
        Count of hash collisions for the Deployment. The Deployment controller uses this field as a collision avoidance mechanism when it needs to create the name for the newest ReplicaSet.

        :return: The collision_count of this ExtensionsV1beta1DeploymentStatus.
        :rtype: int
        """
    ...
    def collision_count(self, collision_count):
        ...
        :param collision_count: The collision_count of this ExtensionsV1beta1DeploymentStatus.
        :type: int
        """
