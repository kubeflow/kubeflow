...
class PolicyV1beta1PodSecurityPolicySpec(object):
    ...
    def __init__(self, allow_privilege_escalation=None, allowed_capabilities=None, allowed_flex_volumes=None, allowed_host_paths=None, allowed_proc_mount_types=None, allowed_unsafe_sysctls=None, default_add_capabilities=None, default_allow_privilege_escalation=None, forbidden_sysctls=None, fs_group=None, host_ipc=None, host_network=None, host_pid=None, host_ports=None, privileged=None, read_only_root_filesystem=None, required_drop_capabilities=None, run_as_user=None, se_linux=None, supplemental_groups=None, volumes=None):
        """
        PolicyV1beta1PodSecurityPolicySpec - a model defined in Swagger
        """
    ...
    def allow_privilege_escalation(self):
        """
        Gets the allow_privilege_escalation of this PolicyV1beta1PodSecurityPolicySpec.
        allowPrivilegeEscalation determines if a pod can request to allow privilege escalation. If unspecified, defaults to true.

        :return: The allow_privilege_escalation of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: bool
        """
    ...
    def allow_privilege_escalation(self, allow_privilege_escalation):
        ...
        :param allow_privilege_escalation: The allow_privilege_escalation of this PolicyV1beta1PodSecurityPolicySpec.
        :type: bool
        """
    ...
    def allowed_capabilities(self):
        """
        Gets the allowed_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        allowedCapabilities is a list of capabilities that can be requested to add to the container. Capabilities in this field may be added at the pod author's discretion. You must not list a capability in both allowedCapabilities and requiredDropCapabilities.

        :return: The allowed_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: list[str]
        """
    ...
    def allowed_capabilities(self, allowed_capabilities):
        ...
        :param allowed_capabilities: The allowed_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        :type: list[str]
        """
    ...
    def allowed_flex_volumes(self):
        """
        Gets the allowed_flex_volumes of this PolicyV1beta1PodSecurityPolicySpec.
        allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the \"volumes\" field.

        :return: The allowed_flex_volumes of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def allowed_flex_volumes(self, allowed_flex_volumes):
        ...
        :param allowed_flex_volumes: The allowed_flex_volumes of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def allowed_host_paths(self):
        ...
        :return: The allowed_host_paths of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def allowed_host_paths(self, allowed_host_paths):
        ...
        :param allowed_host_paths: The allowed_host_paths of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def allowed_proc_mount_types(self):
        """
        Gets the allowed_proc_mount_types of this PolicyV1beta1PodSecurityPolicySpec.
        AllowedProcMountTypes is a whitelist of allowed ProcMountTypes. Empty or nil indicates that only the DefaultProcMountType may be used. This requires the ProcMountType feature flag to be enabled.

        :return: The allowed_proc_mount_types of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: list[str]
        """
    ...
    def allowed_proc_mount_types(self, allowed_proc_mount_types):
        ...
        :param allowed_proc_mount_types: The allowed_proc_mount_types of this PolicyV1beta1PodSecurityPolicySpec.
        :type: list[str]
        """
    ...
    def allowed_unsafe_sysctls(self):
        """
        Gets the allowed_unsafe_sysctls of this PolicyV1beta1PodSecurityPolicySpec.
        ...
        :return: The allowed_unsafe_sysctls of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: list[str]
        """
    ...
    def allowed_unsafe_sysctls(self, allowed_unsafe_sysctls):
        ...
        :param allowed_unsafe_sysctls: The allowed_unsafe_sysctls of this PolicyV1beta1PodSecurityPolicySpec.
        :type: list[str]
        """
    ...
    def default_add_capabilities(self):
        """
        Gets the default_add_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        defaultAddCapabilities is the default set of capabilities that will be added to the container unless the pod spec specifically drops the capability.  You may not list a capability in both defaultAddCapabilities and requiredDropCapabilities. Capabilities added here are implicitly allowed, and need not be included in the allowedCapabilities list.

        :return: The default_add_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: list[str]
        """
    ...
    def default_add_capabilities(self, default_add_capabilities):
        ...
        :param default_add_capabilities: The default_add_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        :type: list[str]
        """
    ...
    def default_allow_privilege_escalation(self):
        """
        Gets the default_allow_privilege_escalation of this PolicyV1beta1PodSecurityPolicySpec.
        defaultAllowPrivilegeEscalation controls the default setting for whether a process can gain more privileges than its parent process.

        :return: The default_allow_privilege_escalation of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: bool
        """
    ...
    def default_allow_privilege_escalation(self, default_allow_privilege_escalation):
        ...
        :param default_allow_privilege_escalation: The default_allow_privilege_escalation of this PolicyV1beta1PodSecurityPolicySpec.
        :type: bool
        """
    ...
    def forbidden_sysctls(self):
        ...
        :return: The forbidden_sysctls of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: list[str]
        """
    ...
    def forbidden_sysctls(self, forbidden_sysctls):
        ...
        :param forbidden_sysctls: The forbidden_sysctls of this PolicyV1beta1PodSecurityPolicySpec.
        :type: list[str]
        """
    ...
    def fs_group(self, fs_group):
        ...
        :param fs_group: The fs_group of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def host_ipc(self, host_ipc):
        ...
        :param host_ipc: The host_ipc of this PolicyV1beta1PodSecurityPolicySpec.
        :type: bool
        """
    ...
    def host_network(self, host_network):
        ...
        :param host_network: The host_network of this PolicyV1beta1PodSecurityPolicySpec.
        :type: bool
        """
    ...
    def host_pid(self, host_pid):
        ...
        :param host_pid: The host_pid of this PolicyV1beta1PodSecurityPolicySpec.
        :type: bool
        """
    ...
    def host_ports(self, host_ports):
        ...
        :param host_ports: The host_ports of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def privileged(self, privileged):
        ...
        :param privileged: The privileged of this PolicyV1beta1PodSecurityPolicySpec.
        :type: bool
        """
    ...
    def read_only_root_filesystem(self):
        """
        Gets the read_only_root_filesystem of this PolicyV1beta1PodSecurityPolicySpec.
        readOnlyRootFilesystem when set to true will force containers to run with a read only root file system.  If the container specifically requests to run with a non-read only root file system the PSP should deny the pod. If set to false the container may run with a read only root file system if it wishes but it will not be forced to.

        :return: The read_only_root_filesystem of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: bool
        """
    ...
    def read_only_root_filesystem(self, read_only_root_filesystem):
        ...
        :param read_only_root_filesystem: The read_only_root_filesystem of this PolicyV1beta1PodSecurityPolicySpec.
        :type: bool
        """
    ...
    def required_drop_capabilities(self):
        """
        Gets the required_drop_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        requiredDropCapabilities are the capabilities that will be dropped from the container.  These are required to be dropped and cannot be added.

        :return: The required_drop_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        :rtype: list[str]
        """
    ...
    def required_drop_capabilities(self, required_drop_capabilities):
        ...
        :param required_drop_capabilities: The required_drop_capabilities of this PolicyV1beta1PodSecurityPolicySpec.
        :type: list[str]
        """
    ...
    def run_as_user(self, run_as_user):
        ...
        :param run_as_user: The run_as_user of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def se_linux(self, se_linux):
        ...
        :param se_linux: The se_linux of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def supplemental_groups(self):
        ...
        :return: The supplemental_groups of this PolicyV1beta1PodSecurityPolicySpec.
    ...
    def supplemental_groups(self, supplemental_groups):
        ...
        :param supplemental_groups: The supplemental_groups of this PolicyV1beta1PodSecurityPolicySpec.
