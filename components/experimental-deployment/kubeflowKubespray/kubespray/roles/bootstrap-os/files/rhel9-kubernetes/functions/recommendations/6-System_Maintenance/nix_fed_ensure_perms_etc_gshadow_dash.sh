...
# ~/CIS-LBK/functions/recommendations/nix_fed_ensure_perms_etc_gshadow_dash.sh
# 
...
fed_ensure_perms_etc_gshadow_dash()
{
	...
	fed_ensure_perms_etc_gshadow_dash_chk()
	{
	...
	fed_ensure_perms_etc_gshadow_dash_fix()
	{
