...
# ~/CIS-LBK/functions/recommendations/nix_ensure_ip_forwarding_disabled.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       10/20/20    Recommendation "Ensure IP forwarding is disabled"
# Eric Pinnell       04/07/22    Modified to enhance logging
...
ensure_ip_forwarding_disabled()
{
	...
	ensure_ip_forwarding_disabled_chk()
	{
		echo "- Start check - Ensure IP forwarding is disabled" | tee -a "$LOG" 2>> "$ELOG"
		l_output="" l_output2="" 
	...
	ensure_ip_forwarding_disabled_fix()
	{
		echo "- Start remediation - Ensure IP forwarding is disabled" | tee -a "$LOG" 2>> "$ELOG"
		l_output="" l_output2="" 
		...
		echo "- End remediation - Ensure IP forwarding is disabled" | tee -a "$LOG" 2>> "$ELOG"
	}
