...
# ~/CIS-LBK/functions/recommendations/nix_ensure_permissions_cron_monthly_configured.sh
# 
# Name                Date       Description
# ------------------------------------------------------------------------------------------------
# Eric Pinnell       11/04/20    Recommendation "Ensure permissions on /etc/cron.monthly are configured"
# Justin Brown		 05/02/22    Update to modern format.
#

ensure_permissions_cron_monthly_configured()
{
	...
	ensure_permissions_cron_monthly_configured_chk()
	{
	...
	ensure_permissions_cron_monthly_configured_fix()
	{
