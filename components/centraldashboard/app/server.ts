...
async function main() {
  ...
  const namespaceCreation = (NAMESPACE_CREATION.toLowerCase() === "true");
  ...
  app.use('/api/workgroup', new WorkgroupApi(profilesService, k8sService, namespaceCreation).routes());
