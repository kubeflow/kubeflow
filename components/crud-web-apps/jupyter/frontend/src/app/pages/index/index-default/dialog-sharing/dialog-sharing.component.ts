...
export class DialogSharing implements OnInit {
 ...
 updateCopyLink(){
  ...
  if (this.selected == 'option1') {
    this.copylink = `${window.location.href.replace(window.location.pathname, '')}/_/jupyter/notebook/auto-start/${this.namespace}/${this.notebook}/view/`;
  } else if(this.selected == 'option2') {
    this.copylink = `${window.location.href.replace(window.location.pathname, '')}/_/jupyter/notebook/auto-start/${this.namespace}/${this.notebook}/`;
  } else{
    this.copylink = `${window.location.href.replace(window.location.pathname, '')}/_/jupyter/notebook/auto-start/${this.namespace}/${this.notebook}/`;
  }
