...
KAFKA_PERSISTENT = os.path.join(
    FILE_ABS_PATH, "yaml/kafka-persistent.yaml"
)

KAFKA_PERSISTENT_SINGLE = os.path.join(
    FILE_ABS_PATH, "yaml/kafka-persistent-single.yaml"
)

KAFKA_JBOD = os.path.join(
    FILE_ABS_PATH, "yaml/kafka-jbod.yaml"
)
...
def load_ephemeral_template(**kwargs):
    """
    ...
    """
    return helpers.load_param_yaml(KAFKA_EPHEMERAL, **kwargs)


def load_ephemeralsingle_template(**kwargs):
    """
    kwargs: the parameters to be replaced in the yaml
    Reads the yaml for the web app's custom resource, replaces the variables
    and returns it as a python dict.
    """
    return helpers.load_param_yaml(KAFKA_EPHEMERAL_SINGLE, **kwargs)


def load_persistent_template(**kwargs):
    """
    kwargs: the parameters to be replaced in the yaml
    Reads the yaml for the web app's custom resource, replaces the variables
    and returns it as a python dict.
    """
    return helpers.load_param_yaml(KAFKA_PERSISTENT, **kwargs)


def load_persistent_single_template(**kwargs):
    """
    kwargs: the parameters to be replaced in the yaml
    Reads the yaml for the web app's custom resource, replaces the variables
    and returns it as a python dict.
    """
    return helpers.load_param_yaml(KAFKA_PERSISTENT_SINGLE, **kwargs)


def load_jbod_template(**kwargs):
    """
    kwargs: the parameters to be replaced in the yaml
    Reads the yaml for the web app's custom resource, replaces the variables
    and returns it as a python dict.
    """
    return helpers.load_param_yaml(KAFKA_JBOD, **kwargs)
