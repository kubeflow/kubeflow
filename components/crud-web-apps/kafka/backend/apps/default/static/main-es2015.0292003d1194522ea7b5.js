...
class IndexDefaultComponent {
    ...
    ngOnInit() {
        ...
        this.subs.add(this.poller.start().subscribe(() => {
            ...
            this.backend.getKafkas(this.currNamespace).subscribe(kafkas => {
                if (!(0,lodash__WEBPACK_IMPORTED_MODULE_2__.isEqual)(this.rawData, kafkas)) {
                    this.rawData = kafkas;
    ...
    processIncomingData(kafkas) {
        const kafkasCopy = JSON.parse(JSON.stringify(kafkas));
...
//# sourceMappingURL=main-es2015.0292003d1194522ea7b5.js.map