...
def post_tensorboard(namespace):
    ...
    log.info("About to create Tensorboard: ", tensorboard)
    api.create_custom_rsrc("tensorboard.kubeflow.org", "v1alpha1", "tensorboards", tensorboard, namespace) # noqa E501
    log.info("Successfully created Tensorboard %s in %s", name, namespace)
