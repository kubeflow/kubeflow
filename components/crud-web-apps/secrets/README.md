...
This web app is responsible for allowing the user to manipulate configs in their Kubeflow cluster. To achieve this it provides a user friendly way to handle the lifecycle of secret objects.
...
cd component/crud-web-apps/secrets/backend
