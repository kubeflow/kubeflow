(function (root, factory) {
  ...
  var patterns = [
    ...
    "έ2ι",
    "έ2ϊ",
    "έ2ϊ", // 'e3i --- not to be separated: to rw-m'ei-ko (one way to pronounce it)
    "ε2υ",
    "ε2ύ",
    "ε2ύ",
    "έ3υ",
    ...
    "ό2ι",
    "ό2ϊ",
    "ό2ϊ", // 'o3i --- not to be separated: to ko-r'oido
    "ο2υ",
    "ο2ύ",
    "ο2ύ",
    "ό3υ",
    ...
    "4τ1φ",
    "στ2φ",
    "ϲτ2φ", // fa-stfount'adiko Be-stfal'ia (German'ia)
    "4τ1χ",
    "4τ1ψ",
    "4φ1β",
    "4φ1γ",
    ...
    "4μσ.",
    "4νς.",
    "4νϲ.", // 'el-minc ('el-min-joc) tranc
    "4νσ.",
    "4ρς.",
    "4ρϲ.", // (empr'oc) marc
    "4ρσ.",
    "4σκ.",
    "4ϲκ.", // Noboros'isk (p'olh thc Rws'iac)
    "4στ.",
    "4ϲτ.", // karst trast
    "4τλ.", // Si'atl (p'olh twn HPA)
    "4τρ.", // maitr
    "4ντς.",
    "4ντϲ.", // (frou'it) pantc Frantc
    "4ντσ.",
    "4φτ.", // kriskr'aft
