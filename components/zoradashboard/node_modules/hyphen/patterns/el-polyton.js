(function (root, factory) {
  ...
  var patterns = [
    ...
    "ά2ι",
    "ά2ϊ",
    "ά2ϊ", // 'a3i --- not to be separated: ne-r'aida
    "α2υ",
    "α2ύ",
    "α2ύ",
    "α2ὺ",
    ...
    "έ2ι",
    "έ2ϊ",
    "έ2ϊ", // 'e3i --- not to be separated: t`o rw-m'ei-ko (one way to pronounce it)
    "ε2υ",
    "ε2ύ",
    "ε2ύ",
    "ε2ὺ",
    ...
    "ό2ι",
    "ό2ϊ",
    "ό2ϊ", // 'o3i --- not to be separated: t`o ko-r'oido
    "ο2υ",
    "ο2ύ",
    "ο2ύ",
    "ο2ὺ",
    ...
    "4ρ1ψ",
    "4σ1δ",
    "4ϲ1δ", // "sd" may not be separable: sde'ugla = ze'ugla (>arq.)
    "4σ1ζ",
    "4ϲ1ζ",
    "4σ1ν",
    "4ϲ1ν", // "sn" may not be separable: sn'iqi (= sb'erkoc) snompism'oc
    "4σ1ξ",
    "4ϲ1ξ",
    "4σ1ρ",
    "4ϲ1ρ",
    ...
    "4τ1φ",
    "στ2φ",
    "ϲτ2φ", // fa-stfountadiko Be-stfal'ia (German'ia)
    "4τ1χ",
    "4τ1ψ",
    "4φ1β",
    "4φ1γ",
    ...
    ".μα5γ2κιό",
    ".μα5γ2κιό", // ma-gki'oroc
    ".μπα5γ2κ", // mpa-gkat'ela mpa-gk'eta
    ".μπι5γ2κ", // mpi-gk'onia
    ".ντά5γ2κλ",
    ".ντά5γ2κλ", // nt'a-gkla (??? not so sure)
    ...
    ".σαλτιπά5γ2κ",
    ".ϲαλτιπά5γ2κ",
    ".ϲαλτιπά5γ2κ", // saltip'a-gkoc (??? not so sure)
    ".σι5γ2κ",
    ".ϲι5γ2κ", // si-gko'una
    ".σπά5γ2κ",
    ".σπά5γ2κ",
    ".ϲπά5γ2κ",
    ".ϲπά5γ2κ", // sp'a-gkoc spa-gkoramm'enoc
    ".σπα5γ2κ",
    ".ϲπα5γ2κ",
    ".φιό5γ2κ",
    ".φιό5γ2κ", // fi'o-gkoc fio-gk'aki
    ".φιο5γ2κ",
    ".χούλι5γ2κ",
    ".χούλι5γ2κ", // qo'uli-gkan qouligk'anoc qouli-gkanism'oc
    ".χουλι5γ2κ",
    ////////
    "4ζ5μ2π",
    "4λ5μ2π",
    ...
    "ἀρα5μ2π", // >ara-mp'ac
    "ἀρλού5μ2π",
    "ἀρλού5μ2π", // >arlo'u-mpa
    "ἀρλοῦ5μ2π",
    "ἀρλου5μ2π",
    ".βό5μ2πιρ",
    ".βό5μ2πιρ", // b'o-mpirac (??? not so sure)
    ...
    ".καλί5μ2πρ",
    ".καλί5μ2πρ", // kal'i-mpra kali-mpr'arw
    ".καλι5μ2πρ",
    ".κα5μ2πάδ",
    ".κα5μ2πάδ", // ka-mp'adikoc (= qontr'oc)
    ".κα5μ2παρέ",
    ".κα5μ2παρέ", // ka-mpa-r'e ka-mparetzo'u
    ".κα5μ2παρὲ",
    ".κα5μ2παρε",
    ".κα5μ2πίν",
    ".κα5μ2πίν", // ka-mp'ina ka-mpin'ec
    ".κα5μ2πῖν",
    ".κα5μ2πιν",
    ".κά5μ2ποτ",
    ".κά5μ2ποτ", // k'a-mpoto (= >agglik'o <'ufasma) ka-mpot'inoc
    ".κα5μ2πότ",
    ".κα5μ2πότ",
    ".κα5μ2ποτ",
    ...
    ".κο6μ3πρέσσ",
    ".κο6μ3πρέϲϲ",
    ".κο6μ3πρέϲϲ", // kom-pr'essa
    ".κο6μ3πρεσσ",
    ".κο6μ3πρεϲϲ",
    ".κοντρα5μ2π", // kontra-mp'aso kontra-mp'anto (= lajremp'orio)
    ".κουλού5μ2πρ",
    ".κουλού5μ2πρ", // koulo'u-mpra (??? not so sure)
    ".κουλοῦ5μ2πρ",
    ".κουλου5μ2πρ",
    ".κου5μ2πού",
    ".κου5μ2πού", // kou-mpo'uri kou-mpo'urac
    ".κου5μ2ποῦ",
    ".κου5μ2που",
    ".κωλού5μ2πρ",
    ".κωλού5μ2πρ", // kwlo'u-mpra (??? not so sure)
    ".κωλοῦ5μ2πρ",
    ".κωλου5μ2πρ",
    ".λι5μ2πρ", // li-mpr'eto
    ".λό5μ2π",
    ".λό5μ2π", // l'o-mpu (i)
    ".μανιτό5μ2π",
    ".μανιτό5μ2π", // manit'o-mpa (sit'ari)
    "5μ2πα5μ2π", // mpa-mp'ac mpa-mp'a-kac mpa-mp'eshc qazo-mpa-mp'ac
    "5μ2πά5μ2π",
    "5μ2πά5μ2π", // mp'a-mpw mp'a-mpouska
    ".μπα6μ3πάκι",
    ".μπα6μ3πάκι", // mpam-p'aki
    ".μπα6μ3πακι",
    ".μπασκε2τ5μ2π",
    ".μπαϲκε2τ5μ2π", // mpasket-mpwl'istac
    ".μπασι5μ2πουζ",
    ".μπαϲι5μ2πουζ", // mpasi-mpouzo~ukoc
    "5μ2πέης.",
    "5μ2πέης.",
    "5μ2πέηϲ.",
    "5μ2πέηϲ.", // Petr'o-mpehc k.>'a.<'o.
    "5μ2πεης.",
    "5μ2πεηϲ.",
    "5μ2πέησ.",
    "5μ2πέησ.",
    ...
    "5μ2πέηδων.",
    "5μ2πέ5μ2π",
    "5μ2πέ5μ2π", // mp'e-mphc mp'e-mpa mpe-mp'ekoc bouturo-mpe-mp'ec
    "5μ2πε5μ2π",
    ...
    ".μπου5μ2πουν",
    ".νό5μ2πελ",
    ".νό5μ2πελ", // n'o-mpel no-mpel'istac
    ".νο5μ2πελ",
    ".ντό5μ2πρ",
    ".ντό5μ2πρ", // nt'o-mproc nto-mpros'unh
    ".ντο5μ2πρ",
    ...
    ".ρέ5μ2π", // r'e-mpeloc
    ".ρεπού5μ2πλ",
    ".ρεπού5μ2πλ", // repo'u-mplika
    ".ρεπου5μ2πλ", // repou-mplik'anoc
    ".ρο5μ2π", // ro-mp'ot, ro-mpotik'h
    "ρό5μ2πα",
    "ρό5μ2πα", // r'o-mpa gkarntar'o-mpa pali'oro-mpa
    "ρό5μ2πε",
    "ρό5μ2πε",
    "ρό5μ2πω",
    "ρό5μ2πω",
    ...
    ".ρου5μ2π", // rou-mp'ini
    ".σα2μ5ποτ",
    ".ϲα2μ5ποτ", // sa-mpot'az sa-mpot'arw
    ".σέ5μ2πρ",
    ".σέ5μ2πρ",
    ".ϲέ5μ2πρ",
    ".ϲέ5μ2πρ", // s'e-mproc
    ".σκα5μ2παβ",
    ".ϲκα5μ2παβ", // ska-mpab'ia
    ".σνο5μ2π",
    ".ϲνο5μ2π", // sno-mpar'ia sno-mpism'oc
    "σό5μ2πα",
    "σό5μ2πα",
    "ϲό5μ2πα",
    "ϲό5μ2πα", // s'o-mpa xul'o-sompa
    "σό5μ2πε",
    "σό5μ2πε",
    "ϲό5μ2πε",
    "ϲό5μ2πε",
    ...
    ".τα6μ3πούρλ",
    ".τε5μ2πεσ",
    ".τε5μ2πεϲ", // te-mpes'iri
    ".τζά5μ2π",
    ".τζά5μ2π", // tz'a-mpa tza-mpatz'hc
    ".τζα5μ2π",
    ...
    ".τό5μ2πρ",
    ".τό5μ2πρ", // t'o-mproc to-mpros'unh To-mpro'uk (= p'olh >Afrik~hc)
    ".το5μ2πρ",
    ".τρα5μ2πάλ",
    ".τρα5μ2πάλ", // tra-mp'ala tra-mpal'izomai
    ".τρα5μ2παλ",
    ...
    ".τσά5μ2πα",
    ".τϲά5μ2πα",
    ".τϲά5μ2πα", // ts'a-mpa tsa-mpatz'hc
    ".τσα5μ2πα",
    ".τϲα5μ2πα",
    ".τσι5μ2πούκ",
    ".τσι5μ2πούκ",
    ".τϲι5μ2πούκ",
    ".τϲι5μ2πούκ", // tsi-mpo'uki
    ".τσι5μ2πουκ",
    ".τϲι5μ2πουκ",
    ".τσι5μ2πούσ",
    ".τσι5μ2πούσ",
    ".τϲι5μ2πούϲ",
    ".τϲι5μ2πούϲ", // tsi-mpo'usi
    ".τσι5μ2πουσ",
    ".τϲι5μ2πουϲ",
    ".φά5μ2πρικ",
    ".φά5μ2πρικ", // f'a-mprika
    ".φα5μ2πρικ",
    ".φρα5μ2π", // fra-mpal'ac
    ...
    "ἀ5ν2τάτζ", // >a-nt'atzio
    "ἀτρα5ν2τέ",
    "ἀτρα5ν2τέ", // >atra-nt'ec
    "ἀτρα5ν2τὲ",
    ".βί5ν2τε",
    ".βί5ν2τε", // b'i-nteo bi-nteok'amera
    ".βι5ν2τε",
    ...
    ".μα5ν2τάμ",
    ".μα5ν2τάμ", // ma-nt'am ma-ntam'itsa
    ".μα5ν2τὰμ",
    ".μα5ν2ταμ",
    ".μα5ν2τέμ",
    ".μα5ν2τέμ", // ma-nt'emi
    ".μα5ν2τεμ",
    ".μεϊ5ν2τά",
    ".μεϊ5ν2τά", // me"i-nt'ani
    ".μεϊ5ν2τα",
    ".μο5ν2τέλ",
    ".μο5ν2τέλ", // mo-nt'elo mo-ntelism'oc
    ".μο5ν2τελ",
    "μο5ν2τέρν",
    "μο5ν2τέρν", // mo-nt'erno metamo-nternism'oc
    "μο5ν2τερν",
    ".μπαλά5ν2τ",
    ".μπαλά5ν2τ", // mpal'a-nta
    ".μπαλα5ν2τ",
    ...
    ".νισα5ν2τ",
    ".νιϲα5ν2τ", // nisa-nt'iri
    ".ντα5ν2τ", // nta-nt'a
    ".ντερμπε5ν2τ", // ntermpe-nt'erhc
    "5ν2τίβαν",
    "5ν2τίβαν", // mpaoulo-nt'ibano
    ".ντου5ν2τούκ",
    ".ντου5ν2τούκ", // ntou-nto'uka
    ".ντου5ν2τοῦκ",
    ".ντου5ν2τουκ",
    ...
    ".τσα5ν2τί",
    ".τϲα5ν2τί",
    ".τϲα5ν2τί", // tsa-nt'ila tsa-nt'iri
    ".τσα5ν2τι",
    ".τϲα5ν2τι",
    ".φαστφου5ν2τ",
    ...
    "6μσ.",
    "6νς.",
    "6νϲ.", // <'el-minc (<'el-min-joc) tr'anc
    "6νσ.",
    "6ρς.",
    "6ρϲ.", // (>empr`oc) m'arc
    "6ρσ.",
    "6σκ.",
    "6ϲκ.", // Noboros'isk (p'olh t~hc Rws'iac)
    "6στ.",
    "6ϲτ.", // k'arst mp'ost
