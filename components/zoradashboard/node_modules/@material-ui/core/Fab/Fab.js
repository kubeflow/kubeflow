...
const FabRoot = styled(ButtonBase, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[styleProps.variant], styles[`size${capitalize(styleProps.size)}`], styleProps.color === 'inherit' && styles.colorInherit, styleProps.color === 'primary' && styles.primary, styleProps.color === 'secondary' && styles.secondary];
  }
})(({
  theme,
  styleProps
