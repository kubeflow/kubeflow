...
const DialogPaper = styled(Paper, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.paper, styles[`scrollPaper${capitalize(styleProps.scroll)}`], styles[`paperWidth${capitalize(String(styleProps.maxWidth))}`], styleProps.fullWidth && styles.paperFullWidth, styleProps.fullScreen && styles.paperFullScreen];
  }
})(({
  theme,
  styleProps
