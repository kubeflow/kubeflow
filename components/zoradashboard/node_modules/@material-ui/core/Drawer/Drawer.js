...
const DrawerPaper = styled(Paper, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.paper, styles[`paperAnchor${capitalize(styleProps.anchor)}`], styleProps.variant !== 'temporary' && styles[`paperAnchorDocked${capitalize(styleProps.anchor)}`]];
  }
})(({
  theme,
  styleProps
