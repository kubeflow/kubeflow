...
var EventBuffer_1 = __importDefault(require("./EventBuffer"));
...
var AWSPinpointProvider = /** @class */ (function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        command = new client_pinpoint_1.PutEventsCommand(eventParams);
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 3, , 4]);
    ...
    AWSPinpointProvider.prototype._pinpointSendStopSession = function (params, handlers) {
        ...
        var requestUrl = core_1.Signer.signUrl(request, accessInfo, serviceInfo, null);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        command = new client_pinpoint_1.UpdateEndpointCommand(update_params);
                        return [4 /*yield*/, this.pinpointClient.send(command)];
                    case 2:
                        data = _a.sent();
    ...
    AWSPinpointProvider.prototype._bufferExists = function () {
        return this._buffer && this._buffer instanceof EventBuffer_1.default;
    };
    AWSPinpointProvider.prototype._initBuffer = function () {
        if (this._bufferExists()) {
            this._flushBuffer();
        }
        this._buffer = new EventBuffer_1.default(this.pinpointClient, this._config);
...
exports.AWSPinpointProvider = AWSPinpointProvider;
/**
