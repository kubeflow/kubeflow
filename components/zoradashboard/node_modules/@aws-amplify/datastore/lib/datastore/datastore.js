...
var DataStore = /** @class */ (function () {
    ...
    DataStore.prototype.checkReadOnlyProperty = function (fields, model, patchesTuple) {
        if (!patchesTuple) {
            ...
            var patchArray = patchesTuple[0].map(function (p) { return [p.path[0], p.value]; });
            patchArray.forEach(function (patch) {
                var _a = __read(__spread(patch), 2), key = _a[0], val = _a[1];
