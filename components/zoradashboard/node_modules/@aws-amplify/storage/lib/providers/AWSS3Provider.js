                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!srcKey || typeof srcKey !== 'string') {
                            throw new Error(StorageErrorStrings_1.StorageErrorStrings.NO_SRC_KEY);
                        }
                        if (!destKey || typeof destKey !== 'string') {
                            throw new Error(StorageErrorStrings_1.StorageErrorStrings.NO_DEST_KEY);
                        }
                    ...
                    case 2:
                        _c.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, s3.send(new client_s3_1.CopyObjectCommand(params))];
                    case 3:
                        _c.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (progressCallback) {
                            if (typeof progressCallback === 'function') {
                                emitter.on(axios_http_handler_1.SEND_DOWNLOAD_PROGRESS_EVENT, function (progress) {
                    ...
                    case 3:
                        response = _b.sent();
                        emitter.removeAllListeners(axios_http_handler_1.SEND_DOWNLOAD_PROGRESS_EVENT);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (progressCallback) {
                            if (typeof progressCallback === 'function') {
                                emitter.on(axios_http_handler_1.SEND_UPLOAD_PROGRESS_EVENT, function (progress) {
                                    progressCallback(progress);
                                });
                            }
                            else {
