...
export declare type CreateEmailTemplateCommandInput = CreateEmailTemplateRequest;
export declare type CreateEmailTemplateCommandOutput = CreateEmailTemplateResponse & __MetadataBearer;
/**
