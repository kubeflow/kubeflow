...
export declare type UpdateTemplateActiveVersionCommandInput = UpdateTemplateActiveVersionRequest;
export declare type UpdateTemplateActiveVersionCommandOutput = UpdateTemplateActiveVersionResponse & __MetadataBearer;
/**
