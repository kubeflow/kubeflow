...
export declare type GetApplicationSettingsCommandInput = GetApplicationSettingsRequest;
export declare type GetApplicationSettingsCommandOutput = GetApplicationSettingsResponse & __MetadataBearer;
/**
