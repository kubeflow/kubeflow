...
export declare type DeleteEventStreamCommandInput = DeleteEventStreamRequest;
export declare type DeleteEventStreamCommandOutput = DeleteEventStreamResponse & __MetadataBearer;
/**
