...
export declare type GetJourneyExecutionMetricsCommandInput = GetJourneyExecutionMetricsRequest;
export declare type GetJourneyExecutionMetricsCommandOutput = GetJourneyExecutionMetricsResponse & __MetadataBearer;
/**
