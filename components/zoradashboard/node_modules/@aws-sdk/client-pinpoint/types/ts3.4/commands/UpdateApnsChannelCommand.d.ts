...
export declare type UpdateApnsChannelCommandInput = UpdateApnsChannelRequest;
export declare type UpdateApnsChannelCommandOutput = UpdateApnsChannelResponse & __MetadataBearer;
/**
