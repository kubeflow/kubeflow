...
export declare type GetSegmentVersionCommandInput = GetSegmentVersionRequest;
export declare type GetSegmentVersionCommandOutput = GetSegmentVersionResponse & __MetadataBearer;
/**
