...
export declare type ListTemplateVersionsCommandInput = ListTemplateVersionsRequest;
export declare type ListTemplateVersionsCommandOutput = ListTemplateVersionsResponse & __MetadataBearer;
/**
