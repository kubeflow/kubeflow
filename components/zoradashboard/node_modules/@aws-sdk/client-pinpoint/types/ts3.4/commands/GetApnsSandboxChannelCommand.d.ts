...
export declare type GetApnsSandboxChannelCommandInput = GetApnsSandboxChannelRequest;
export declare type GetApnsSandboxChannelCommandOutput = GetApnsSandboxChannelResponse & __MetadataBearer;
/**
