...
export declare type GetAdmChannelCommandInput = GetAdmChannelRequest;
export declare type GetAdmChannelCommandOutput = GetAdmChannelResponse & __MetadataBearer;
/**
