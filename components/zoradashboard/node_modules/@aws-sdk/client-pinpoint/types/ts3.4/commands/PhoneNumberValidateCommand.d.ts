...
export declare type PhoneNumberValidateCommandInput = PhoneNumberValidateRequest;
export declare type PhoneNumberValidateCommandOutput = PhoneNumberValidateResponse & __MetadataBearer;
/**
