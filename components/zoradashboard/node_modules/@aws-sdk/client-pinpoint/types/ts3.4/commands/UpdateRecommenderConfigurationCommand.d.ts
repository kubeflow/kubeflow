...
export declare type UpdateRecommenderConfigurationCommandInput = UpdateRecommenderConfigurationRequest;
export declare type UpdateRecommenderConfigurationCommandOutput = UpdateRecommenderConfigurationResponse & __MetadataBearer;
/**
