...
export declare type GetRecommenderConfigurationCommandInput = GetRecommenderConfigurationRequest;
export declare type GetRecommenderConfigurationCommandOutput = GetRecommenderConfigurationResponse & __MetadataBearer;
/**
