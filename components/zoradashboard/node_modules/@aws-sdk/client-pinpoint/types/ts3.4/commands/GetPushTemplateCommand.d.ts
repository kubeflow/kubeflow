...
export declare type GetPushTemplateCommandInput = GetPushTemplateRequest;
export declare type GetPushTemplateCommandOutput = GetPushTemplateResponse & __MetadataBearer;
/**
