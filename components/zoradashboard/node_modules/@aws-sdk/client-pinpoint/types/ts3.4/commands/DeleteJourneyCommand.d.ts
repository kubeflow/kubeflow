...
export declare type DeleteJourneyCommandInput = DeleteJourneyRequest;
export declare type DeleteJourneyCommandOutput = DeleteJourneyResponse & __MetadataBearer;
/**
