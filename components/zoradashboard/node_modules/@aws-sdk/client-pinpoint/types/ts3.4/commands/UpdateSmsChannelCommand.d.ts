...
export declare type UpdateSmsChannelCommandInput = UpdateSmsChannelRequest;
export declare type UpdateSmsChannelCommandOutput = UpdateSmsChannelResponse & __MetadataBearer;
/**
