...
export declare type GetVoiceTemplateCommandInput = GetVoiceTemplateRequest;
export declare type GetVoiceTemplateCommandOutput = GetVoiceTemplateResponse & __MetadataBearer;
/**
