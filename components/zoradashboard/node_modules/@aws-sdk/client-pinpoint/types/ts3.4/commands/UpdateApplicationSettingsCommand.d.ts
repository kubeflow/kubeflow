...
export declare type UpdateApplicationSettingsCommandInput = UpdateApplicationSettingsRequest;
export declare type UpdateApplicationSettingsCommandOutput = UpdateApplicationSettingsResponse & __MetadataBearer;
/**
