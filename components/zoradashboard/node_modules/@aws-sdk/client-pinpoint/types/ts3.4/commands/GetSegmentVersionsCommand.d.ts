...
export declare type GetSegmentVersionsCommandInput = GetSegmentVersionsRequest;
export declare type GetSegmentVersionsCommandOutput = GetSegmentVersionsResponse & __MetadataBearer;
/**
