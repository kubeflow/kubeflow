...
export declare type DeletePushTemplateCommandInput = DeletePushTemplateRequest;
export declare type DeletePushTemplateCommandOutput = DeletePushTemplateResponse & __MetadataBearer;
/**
