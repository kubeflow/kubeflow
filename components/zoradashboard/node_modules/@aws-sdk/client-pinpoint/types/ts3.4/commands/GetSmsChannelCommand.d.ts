...
export declare type GetSmsChannelCommandInput = GetSmsChannelRequest;
export declare type GetSmsChannelCommandOutput = GetSmsChannelResponse & __MetadataBearer;
/**
