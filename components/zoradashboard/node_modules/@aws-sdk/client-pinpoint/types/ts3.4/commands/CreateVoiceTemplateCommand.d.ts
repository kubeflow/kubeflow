...
export declare type CreateVoiceTemplateCommandInput = CreateVoiceTemplateRequest;
export declare type CreateVoiceTemplateCommandOutput = CreateVoiceTemplateResponse & __MetadataBearer;
/**
