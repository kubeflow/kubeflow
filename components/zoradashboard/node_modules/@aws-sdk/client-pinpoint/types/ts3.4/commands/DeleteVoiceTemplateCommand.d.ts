...
export declare type DeleteVoiceTemplateCommandInput = DeleteVoiceTemplateRequest;
export declare type DeleteVoiceTemplateCommandOutput = DeleteVoiceTemplateResponse & __MetadataBearer;
/**
