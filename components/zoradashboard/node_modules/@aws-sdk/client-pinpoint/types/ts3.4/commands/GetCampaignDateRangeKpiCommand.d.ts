...
export declare type GetCampaignDateRangeKpiCommandInput = GetCampaignDateRangeKpiRequest;
export declare type GetCampaignDateRangeKpiCommandOutput = GetCampaignDateRangeKpiResponse & __MetadataBearer;
/**
