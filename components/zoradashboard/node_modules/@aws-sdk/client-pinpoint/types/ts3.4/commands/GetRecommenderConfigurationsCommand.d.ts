...
export declare type GetRecommenderConfigurationsCommandInput = GetRecommenderConfigurationsRequest;
export declare type GetRecommenderConfigurationsCommandOutput = GetRecommenderConfigurationsResponse & __MetadataBearer;
/**
