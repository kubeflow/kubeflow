...
export declare type SendUsersMessagesCommandInput = SendUsersMessagesRequest;
export declare type SendUsersMessagesCommandOutput = SendUsersMessagesResponse & __MetadataBearer;
/**
