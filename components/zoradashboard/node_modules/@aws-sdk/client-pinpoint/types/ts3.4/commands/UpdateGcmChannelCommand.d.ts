...
export declare type UpdateGcmChannelCommandInput = UpdateGcmChannelRequest;
export declare type UpdateGcmChannelCommandOutput = UpdateGcmChannelResponse & __MetadataBearer;
/**
