...
export declare type UpdateVoiceTemplateCommandInput = UpdateVoiceTemplateRequest;
export declare type UpdateVoiceTemplateCommandOutput = UpdateVoiceTemplateResponse & __MetadataBearer;
/**
