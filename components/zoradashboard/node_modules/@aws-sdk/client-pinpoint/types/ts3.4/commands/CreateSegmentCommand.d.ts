...
export declare type CreateSegmentCommandInput = CreateSegmentRequest;
export declare type CreateSegmentCommandOutput = CreateSegmentResponse & __MetadataBearer;
/**
