...
export declare type UpdateJourneyCommandInput = UpdateJourneyRequest;
export declare type UpdateJourneyCommandOutput = UpdateJourneyResponse & __MetadataBearer;
/**
