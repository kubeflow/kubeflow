...
export declare type UpdateJourneyStateCommandInput = UpdateJourneyStateRequest;
export declare type UpdateJourneyStateCommandOutput = UpdateJourneyStateResponse & __MetadataBearer;
/**
