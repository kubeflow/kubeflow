...
export declare type DeleteUserEndpointsCommandInput = DeleteUserEndpointsRequest;
export declare type DeleteUserEndpointsCommandOutput = DeleteUserEndpointsResponse & __MetadataBearer;
/**
