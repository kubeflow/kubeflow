...
export declare type GetVoiceChannelCommandInput = GetVoiceChannelRequest;
export declare type GetVoiceChannelCommandOutput = GetVoiceChannelResponse & __MetadataBearer;
/**
