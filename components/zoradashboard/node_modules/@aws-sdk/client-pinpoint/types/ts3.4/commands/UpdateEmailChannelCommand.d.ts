...
export declare type UpdateEmailChannelCommandInput = UpdateEmailChannelRequest;
export declare type UpdateEmailChannelCommandOutput = UpdateEmailChannelResponse & __MetadataBearer;
/**
