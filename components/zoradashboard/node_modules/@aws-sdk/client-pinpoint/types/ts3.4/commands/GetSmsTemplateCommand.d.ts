...
export declare type GetSmsTemplateCommandInput = GetSmsTemplateRequest;
export declare type GetSmsTemplateCommandOutput = GetSmsTemplateResponse & __MetadataBearer;
/**
