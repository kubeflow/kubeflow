...
export declare type GetBaiduChannelCommandInput = GetBaiduChannelRequest;
export declare type GetBaiduChannelCommandOutput = GetBaiduChannelResponse & __MetadataBearer;
/**
