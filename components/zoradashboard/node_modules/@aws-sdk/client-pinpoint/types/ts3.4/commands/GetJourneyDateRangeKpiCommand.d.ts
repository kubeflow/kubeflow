...
export declare type GetJourneyDateRangeKpiCommandInput = GetJourneyDateRangeKpiRequest;
export declare type GetJourneyDateRangeKpiCommandOutput = GetJourneyDateRangeKpiResponse & __MetadataBearer;
/**
