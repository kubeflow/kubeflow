...
export declare type UpdateVoiceChannelCommandInput = UpdateVoiceChannelRequest;
export declare type UpdateVoiceChannelCommandOutput = UpdateVoiceChannelResponse & __MetadataBearer;
/**
