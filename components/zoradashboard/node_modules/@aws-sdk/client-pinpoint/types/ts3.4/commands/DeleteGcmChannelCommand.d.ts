...
export declare type DeleteGcmChannelCommandInput = DeleteGcmChannelRequest;
export declare type DeleteGcmChannelCommandOutput = DeleteGcmChannelResponse & __MetadataBearer;
/**
