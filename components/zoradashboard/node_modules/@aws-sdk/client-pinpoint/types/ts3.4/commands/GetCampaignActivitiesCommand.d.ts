...
export declare type GetCampaignActivitiesCommandInput = GetCampaignActivitiesRequest;
export declare type GetCampaignActivitiesCommandOutput = GetCampaignActivitiesResponse & __MetadataBearer;
/**
