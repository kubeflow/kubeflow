...
export declare type GetApnsChannelCommandInput = GetApnsChannelRequest;
export declare type GetApnsChannelCommandOutput = GetApnsChannelResponse & __MetadataBearer;
/**
