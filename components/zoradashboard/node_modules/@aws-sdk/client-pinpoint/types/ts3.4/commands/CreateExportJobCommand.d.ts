...
export declare type CreateExportJobCommandInput = CreateExportJobRequest;
export declare type CreateExportJobCommandOutput = CreateExportJobResponse & __MetadataBearer;
/**
