...
export declare type RemoveAttributesCommandInput = RemoveAttributesRequest;
export declare type RemoveAttributesCommandOutput = RemoveAttributesResponse & __MetadataBearer;
/**
