...
export declare type UpdateEmailTemplateCommandInput = UpdateEmailTemplateRequest;
export declare type UpdateEmailTemplateCommandOutput = UpdateEmailTemplateResponse & __MetadataBearer;
/**
