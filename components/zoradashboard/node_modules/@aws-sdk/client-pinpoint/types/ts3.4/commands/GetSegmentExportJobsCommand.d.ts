...
export declare type GetSegmentExportJobsCommandInput = GetSegmentExportJobsRequest;
export declare type GetSegmentExportJobsCommandOutput = GetSegmentExportJobsResponse & __MetadataBearer;
/**
