...
import { _getChild, uploadBytesResumable, _UploadTask, _FbsBlob, listAll, list, getMetadata, updateMetadata, getDownloadURL, deleteObject, StringFormat as StringFormat$1, ref, _Location } from '@firebase/storage';
...
var ReferenceCompat = /** @class */ (function () {
    ...
    ReferenceCompat.prototype.putString = function (value, format, metadata) {
        if (format === void 0) { format = StringFormat$1.RAW; }
