...
const fetch = nodeFetch__namespace;
/**
...
function factory(container, { instanceIdentifier: url }) {
    ...
    const storageServiceCompat = new StorageServiceCompat(app, new StorageService(app, authProvider, appCheckProvider, new ConnectionPool(), url, firebase__default['default'].SDK_VERSION));
