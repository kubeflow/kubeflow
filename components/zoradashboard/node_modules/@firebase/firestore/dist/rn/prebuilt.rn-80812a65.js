import { createMockUserToken, getModularInstance, getUA, base64, isSafari, isMobileCordova, isReactNative, isElectron, isIE, isUWP, isBrowserExtension } from '@firebase/util';
 ...
 */ class Vs {
    ...
    constructor(t, n, s) {
        ...
        // log on 12.2.
        12.2 === Vs._t(getUA()) && V("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = getUA(), n = Vs._t(t), s = 0 < n && n < 10, i = Vs.Et(t), r = 0 < i && i < 4.5;
        // IE 10
...
/** Implements the steps for LRU garbage collection. */ class Ai {
    ...
    fe(t, e) {
        ...
        this.removeOrphanedDocuments(t, n)))).next((t => {
            if (u = Date.now(), v() <= LogLevel.DEBUG) {
 ...
 */ class Ki {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (Jt(e) || Yt(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (v() <= LogLevel.DEBUG && P("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), oe(e)), 
    ...
    Dn(t, e) {
        return v() <= LogLevel.DEBUG && P("QueryEngine", "Using full collection scan to execute query:", oe(e)), 
...
class {
    ...
    Oi(t, e) {
        const n = [ this.Di, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], a = createWebChannelTransport(), h = getStatEventTarget(), l = {
 ...
 */
            ...
            t.stat === Stat.PROXY ? P("Connection", "Detected buffering proxy") : t.stat === Stat.NOPROXY && P("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
...
function wu(t, e, ...n) {
    if (t = getModularInstance(t), eu("collection", "path", e), t instanceof hu) {
 ...
 * Firestore database.
 */ function gu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), (t instanceof lu || t instanceof du) && (e instanceof lu || e instanceof du) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function yu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof fu && e instanceof fu && (t.firestore === e.firestore && ie(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function Yu(t, e) {
    ...
    // from firestore-exp.
    t = getModularInstance(t))) return ta("Unsupported field value:", e, t), Xu(t, e);
    if (t instanceof Nu) 
 ...
 */ function ea(t, e, n) {
    ...
    // FieldPath.
    e = getModularInstance(e)) instanceof Du) return e._internalPath;
...
function Aa(t, e, n, s) {
    if (n[0] = getModularInstance(n[0]), n[0] instanceof oa) return function(t, e, n, s, i) {
 ...
 */ class Da {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Du ? Hu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : zu(this._dataReader, "WriteBatch.update", i._key, e), 
...
function Ca(t, e) {
    if ((t = getModularInstance(t)).firestore !== e) throw new R(A.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function xa(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof Du ? Hu(r, "updateDoc", t._key, e, n, s) : zu(r, "updateDoc", t._key, e);
 ...
 */ class Oa extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof Du ? Hu(this._dataReader, "Transaction.update", i._key, e, n, s) : zu(this._dataReader, "Transaction.update", i._key, e), 
...
class Ha {
    ...
    isEqual(t) {
        return (t = getModularInstance(t)) instanceof lu && gu(this._delegate, t);
    }
    set(t, e) {
 ...
 */ class oh {
    ...
    isEqual(t) {
        return (t = getModularInstance(t)) instanceof Du && this._delegate._internalPath.isEqual(t._internalPath);
    }
}
...
export { Au as A, Ga as G, Ha as H, Iu as I, Ka as K, L, Ua as U, Wa as W, Za as Z, La as a, ah as b, ch as c, eh as e, ih as i, ja as j, oh as o, sh as s, th as t, uh as u, xu as x };
//# sourceMappingURL=prebuilt.rn-80812a65.js.map
