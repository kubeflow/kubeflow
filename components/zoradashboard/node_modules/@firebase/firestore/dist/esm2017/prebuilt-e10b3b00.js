import { createMockUserToken, getModularInstance, getUA, isSafari, isMobileCordova, isReactNative, isElectron, isIE, isUWP, isBrowserExtension } from '@firebase/util';
 ...
 */ class vs {
    ...
    constructor(e, n, s) {
        ...
        // log on 12.2.
        12.2 === vs._t(getUA()) && P("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static yt() {
        ...
        // Check the UA string to find out the browser.
                const e = getUA(), n = vs._t(e), s = 0 < n && n < 10, i = vs.Et(e), r = 0 < i && i < 4.5;
        // IE 10
...
/** Implements the steps for LRU garbage collection. */ class Ti {
    ...
    fe(t, e) {
        ...
        this.removeOrphanedDocuments(t, n)))).next((t => {
            if (u = Date.now(), b() <= LogLevel.DEBUG) {
...
class {
    ...
    Oi(t, e) {
        ...
        this.useFetchStreams && (l.xmlHttpFactory = new FetchXmlHttpFactory({})), this.Fi(l.initMessageHeaders, e), 
...
export { Cu as C, Eu as E, M, Qa as Q, Tu as T, Ua as U, Wa as W, Xa as X, Za as Z, Ma as a, ch as c, ja as j, nh as n, oh as o, qa as q, rh as r, sh as s, th as t, uh as u, za as z };
//# sourceMappingURL=prebuilt-e10b3b00.js.map
