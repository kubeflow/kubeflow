...
var _createForOfIteratorHelperLoose__default = /*#__PURE__*/_interopDefault(_createForOfIteratorHelperLoose);
...
var styledTransformer = function styledTransformer(_ref) {
  ...
  var getStyledIdentifier = function getStyledIdentifier() {
    if (!styledBaseImport || styledBaseImport[0] === importSource && styledBaseImport[1] === importSpecifierName) {
      return importSpecifierName === 'default' ? t.identifier(path.get('specifiers').find(function (p) {
        return p.isImportDefaultSpecifier();
  ...
  return {
    ...
    visitor: {
      ...
      Program: function Program(path, state) {
        ...
        Object.keys(state.opts.importMap || {}).forEach(function (importSource) {
          ...
          Object.keys(value).forEach(function (localExportName) {
            var _value$localExportNam = value[localExportName],
                ...
                options = _objectWithoutPropertiesLoose__default['default'](_value$localExportNam, ["canonicalImport"]);
            ...
            transformers[localExportName] = [exportTransformer, _extends__default['default']({}, defaultOptions, extraOptions, options)];
          });
        ...
        for (var _iterator = _createForOfIteratorHelperLoose__default['default'](path.node.body), _step; !(_step = _iterator()).done;) {
          var _ret = _loop();
