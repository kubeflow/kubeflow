...
func (r *NotebookReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	mapPodToRequest := func(_ context.Context, object client.Object) []reconcile.Request {
	...
	mapEventToRequest := func(_ context.Context, object client.Object) []reconcile.Request {
		return []reconcile.Request{
			{NamespacedName: types.NamespacedName{
				Name:      object.GetName(),
				Namespace: object.GetNamespace(),
