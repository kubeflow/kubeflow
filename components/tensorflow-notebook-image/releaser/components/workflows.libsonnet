      ...
      }.result;
      {
        ...
        spec: {
          ...
          templates: [
            ...
            buildImageTemplate("1.4.1", "1-4-1", "cpu", "disable_install"),
            buildImageTemplate("1.4.1", "1-4-1", "gpu", "disable_install"),
            buildImageTemplate("1.5.1", "1-5-1", "cpu", "disable_install"),
            buildImageTemplate("1.5.1", "1-5-1", "gpu", "disable_install"),
            ...
            buildImageTemplate("1.9.0", "1-9-0", "cpu", "default"),
            buildImageTemplate("1.9.0", "1-9-0", "gpu", "default"),
            buildImageTemplate("1.10.1", "1-10-1", "cpu", "default"),
            buildImageTemplate("1.10.1", "1-10-1", "gpu", "default"),
            {
              name: "exit-handler",
              steps: [
                [{
