...
def create_workflow(name=None, namespace=None, bucket=None, **kwargs):
    ...
    return builder.build(dockerfile="components/example-notebook-servers/jupyter-tensorflow/Dockerfile.CPU",
                         context="components/example-notebook-servers/jupyter-tensorflow/",
                         destination=config.NOTEBOOK_SERVER_JUPYTER_TENSORFLOW,
                         second_dockerfile="components/example-notebook-servers/jupyter-tensorflow/Dockerfile.CUDA",
