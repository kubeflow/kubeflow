...
export IMAGENAME=studyjob-controller
ks generate release ${IMAGENAME} --extra_repos=kubeflow/testing@HEAD\;kubeflow/katib@HEAD --image=${IMAGENAME} --dockerfileDir=kubeflow/katib/cmd/studyjobcontroller
export IMAGENAME=metrics-collector
ks generate release ${IMAGENAME} --extra_repos=kubeflow/testing@HEAD\;kubeflow/katib@HEAD --image=${IMAGENAME} --dockerfileDir=kubeflow/katib/cmd/metricscollector
